 ...
 * <p>Note:
 *
 * <p>Only the space character ' ' is considered as whitespace character. Assume we are dealing
 * with
 ...
 *
 * <p>Input: "42" Output: 42 Example 2:
 *
 * <p>Input: " -42" Output: -42 Explanation: The first non-whitespace character is '-', which is
 * the
 ...
 *
 * <p>Input: "words and 987" Output: 0 Explanation: The first non-whitespace character is 'w',
 * which
 * is not a numerical digit or a +/- sign. Therefore no valid conversion could be performed. Example
 * 5:
 *
 * <p>Input: "-91283472332" Output: -2147483648 Explanation: The number "-91283472332" is out of
 * the
...
public class StringToIntegerAtoi {
  ...
  private String lTrimNative(String str) {
    int i = 0;
